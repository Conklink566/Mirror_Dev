...
#pragma warning disable CS0618 // UNET is obsolete
		...
		//{
  //          //reusableunetwriter.StartMessage(msgId); //UNet Code
  //          //reusableunetwriter.Write(msgId);
  //          reusableunetwriter.Write(buffer, 0, bytecount);
		//	//reusableunetwriter.FinishMessage(); //UNet Code
  ...
  //          //reusableunetwriter.StartMessage(msgId); //UNet Code
  //          //reusableunetwriter.Write(msgId);
  //          reusableunetwriter.Write(bitstream);
		//	//reusableunetwriter.FinishMessage(); //UNet Code
  ...
  //              {
  //                  //NetworkServer.SendWriterToReady(null, reusableunetwriter, Channels.DefaultUnreliable); //UNet Code
  //                  BytesMessage msg = new BytesMessage();
  //                  msg.Serialize(reusableunetwriter);
  ...
  //              {
  //                  //ClientScene.readyConnection.SendWriter(reusableunetwriter, Channels.DefaultUnreliable); //UNet Code
  //                  BytesMessage msg = new BytesMessage();
  //                  msg.Serialize(reusableunetwriter);
  ...
  //                      if (nc.isReady)
  //                      {
  //                          //nc.SendWriter(unetwriter, channel); //UNet Code
  //                          BytesMessage msg = new BytesMessage();
  //                          msg.Serialize(unetwriter);
  //                          nc.Send((short)MsgType.Rpc, msg, channel);
  //                      }
		//			}
		//	}
