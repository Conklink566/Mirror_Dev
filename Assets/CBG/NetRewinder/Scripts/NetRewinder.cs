...
namespace CBG {
    ...
    public class NetRewinder : MonoBehaviour {
        ...
        public void Init() {
            ...
            if (timeErrorMargin < 0)
                timeErrorMargin = .001f;
        ...
        /// <summary>
        /// Build our collider array from all children that contain colliders
        /// </summary>
        public void GetHitboxes() {
            hitBoxes = GetHitboxes(transform, true).ToArray();
            Init();
        }

        /// <summary>
        /// Set our colliders to match the provided list
        /// </summary>
        /// <param name="boxes"></param>
        public void SetHitboxes(List<Transform> boxes) {
            hitBoxes = boxes.ToArray();
            Init();
        }
