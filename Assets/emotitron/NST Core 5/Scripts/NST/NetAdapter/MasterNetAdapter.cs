...
namespace emotitron.NST
{
	...
	public class MasterNetAdapter : MonoBehaviour //, INSTMasterAdapter
	{
		...
		public void OnNetworkDestroy()
		{
            ...
            {
                //NetworkServer.UnregisterHandler(HeaderSettings.Single.masterMsgTypeId); //UNet Code
                NetworkServer.UnregisterHandler((short)MsgType.DefaultMsgTypeId);
            }
		...
		private void RegisterHanders()
		{
            ...
            //masterMsgTypeId = HeaderSettings.Single.masterMsgTypeId; //UNet Code
            masterMsgTypeId = (short)MsgType.DefaultMsgTypeId;
		...
		private static void ReceiveUpdate(NetworkMessage msg)
		{
			...
			{
                //writer.StartMessage(msg.msgType); //UNet Code
                ...
                BytesMessage bMsg = new BytesMessage(messageBytes);
                NetworkServer.SendToAll(msg.msgType, bMsg);
                //if (NetworkServer.connections[0] != null)
                //	NetworkServer.connections[0].FlushChannels(); //UNet Code
            }
		}
		...
		public static void SendUpdate(ref UdpBitStream bitstream, ref UdpBitStream outstream)
		{
			...
			else
			{
                ...
                {
                    //NetworkManager.singleton.client.SendWriter(writer, Channels.DefaultUnreliable); //UNet Code
                    
                    NetworkManager.singleton.client.Send(masterMsgTypeId, msg);
                }
